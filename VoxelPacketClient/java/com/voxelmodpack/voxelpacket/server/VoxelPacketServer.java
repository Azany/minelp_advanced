package com.voxelmodpack.voxelpacket.server;
...
import com.voxelmodpack.voxelpacket.common.VoxelMessage;
import com.voxelmodpack.voxelpacket.common.VoxelPacket;
import com.voxelmodpack.voxelpacket.common.VoxelPacketHandlerBase;
import com.voxelmodpack.voxelpacket.common.interfaces.IPacketSenderDelegate;
import com.voxelmodpack.voxelpacket.common.interfaces.IVoxelMessagePublisher;
import com.voxelmodpack.voxelpacket.common.interfaces.IVoxelMessageSubscriber;
import com.voxelmodpack.voxelpacket.common.struct.QueryResponse;
import com.voxelmodpack.voxelpacket.exceptions.InvalidShortcodeException;
import com.voxelmodpack.voxelpacket.exceptions.MissingEncoderException;
import com.voxelmodpack.voxelpacket.exceptions.VoxelPacketException;
...
public class VoxelPacketServer extends VoxelPacketHandlerBase implements IVoxelMessageSubscriber
{
	 ...
	 */
	public void sendMessage(String shortCode, Object messageData, Entity relevantEntity) throws MissingEncoderException, InvalidShortcodeException
	{
	 ...
	 * @throws InvalidShortcodeException
	 */
	public void sendMessageTo(EntityPlayerMP player, String shortCode, Object messageData, Entity relevantEntity) throws MissingEncoderException, InvalidShortcodeException
	{
	 ...
	 * @throws InvalidShortcodeException
	 */
	public void sendMessageToKnownSubscribers(String shortCode, Object messageData, Entity relevantEntity) throws MissingEncoderException, InvalidShortcodeException
	{
	 ...
	 * @throws InvalidShortcodeException
	 */
	public void sendMessageToPlayers(List<EntityPlayerMP> players, String shortCode, Object messageData, Entity relevantEntity) throws MissingEncoderException, InvalidShortcodeException
	{
	 ...
	 */
	protected void onSendPayloadToPlayer(EntityPlayerMP player, String channel, PacketBuffer payload)
	{
		try
		{
		...
		for (Entry<String, ArrayList<String>> subscriptionInfo : this.clientSubscriberMap.entrySet())
		{
			if (subscriptionInfo.getValue().contains(shortCode))
			{
				...
				if (integratedServer != null)
				{
					...
					EntityPlayerMP player = configurationManager.getPlayerByUsername(subscriptionInfo.getKey());
	...
	class PlayerDelegate implements IPacketSenderDelegate
	{
		...
		@Override
		public void sendPayload(String channel, PacketBuffer payload)
		{
