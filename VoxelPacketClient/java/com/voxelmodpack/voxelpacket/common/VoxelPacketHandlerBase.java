...
import com.voxelmodpack.voxelpacket.common.encoders.VoxelPacketEncoderCoord3D;
import com.voxelmodpack.voxelpacket.common.encoders.VoxelPacketEncoderEntityNBT;
import com.voxelmodpack.voxelpacket.common.encoders.VoxelPacketEncoderFloat;
import com.voxelmodpack.voxelpacket.common.encoders.VoxelPacketEncoderInt;
import com.voxelmodpack.voxelpacket.common.encoders.VoxelPacketEncoderIntArray;
import com.voxelmodpack.voxelpacket.common.encoders.VoxelPacketEncoderNull;
import com.voxelmodpack.voxelpacket.common.encoders.VoxelPacketEncoderObject;
import com.voxelmodpack.voxelpacket.common.encoders.VoxelPacketEncoderRaw;
import com.voxelmodpack.voxelpacket.common.encoders.VoxelPacketEncoderString;
...
public abstract class VoxelPacketHandlerBase implements IVoxelPacketHandler, IVoxelMessagePublisher
{
	...
	protected void sendMessage(IPacketSenderDelegate packetSender, String shortCode, Object messageData, Entity relevantEntity) throws MissingEncoderException, InvalidShortcodeException
	{
		...
		if (encoder != null)
		{
			...
			packetSender.sendPayload(VoxelPacket.VOXELPACKET_CHANNEL, VoxelPacket.createPayload(dataTypeId, relevantEntity, shortCode, payload));
		}
		else
		{
