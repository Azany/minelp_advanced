...
public class pm_skeletonPony
    ...
    protected void rotateLegs(float move, float swing, float tick) {
        ...
        if (!this.isFlying || !this.isPegasus) {
            ...
            rightArmRotateAngleX = MathHelper.cos((float) (move * 0.6662f + 3.1415927f + raQuad)) * 0.6f * swing;
            leftArmRotateAngleX = MathHelper.cos((float) (move * 0.6662f + laQuad)) * 0.6f * swing;
            rightLegRotateAngleX = MathHelper.cos((float) (move * 0.6662f + rlQuad)) * 0.6f * swing;
            leftLegRotateAngleX = MathHelper.cos((float) (move * 0.6662f + 3.1415927f + llQuad)) * 0.6f * swing;
        ...
        if (this.m != 0) {
            ...
            if (this.glowColor == 0) {
                ...
                this.unicornarm.rotateAngleZ += MathHelper.cos((float) (tick * 0.09f)) * 0.05f + 0.05f;
                this.unicornarm.rotateAngleX += MathHelper.sin((float) (tick * 0.067f)) * 0.1f;
            }
        }
    }
    ...
    protected void fixSpecialRotationPoints(float move) {
        if (this.m != 0 && this.glowColor == 0) {
            this.setRotationPoint(this.RightArm, -1.5f, 9.5f, 4.0f);
        }
    }
    ...
    protected void renderLegs() {
        GL11.glPushMatrix();
        GL11.glTranslatef((float) 0.05f, (float) -0.21f, (float) -0.0f);
        GL11.glScalef((float) 0.5f, (float) 1.15f, (float) 0.5f);
        this.LeftArm.render(this.scale);
        GL11.glPopMatrix();
        GL11.glPushMatrix();
        if (this.m != 0 && this.glowColor == 0) {
            GL11.glTranslatef((float) -0.1f, (float) 0.3f, (float) 0.1f);
            GL11.glScalef((float) 0.5f, (float) 0.5f, (float) 1.2f);
        } else {
            GL11.glTranslatef((float) -0.05f, (float) -0.21f, (float) -0.0f);
            GL11.glScalef((float) 0.5f, (float) 1.2f, (float) 0.5f);
        }
        this.RightArm.render(this.scale);
        GL11.glPopMatrix();
        GL11.glPushMatrix();
        GL11.glTranslatef((float) 0.05f, (float) -0.21f, (float) 0.35f);
        GL11.glScalef((float) 0.5f, (float) 1.2f, (float) 0.5f);
