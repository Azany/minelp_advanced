...
public class VoxelPropertyCheckBox extends VoxelPropertyToggleButton
{
	...
	public VoxelPropertyCheckBox(IVoxelPropertyProviderBoolean propertyProvider, String binding, String text, int xPos, int yPos)
	{
		this(propertyProvider, binding, text, xPos, yPos, null);
	}
	
	public VoxelPropertyCheckBox(IVoxelPropertyProviderBoolean propertyProvider, String binding, String text, int xPos, int yPos, VoxelPropertyCheckBox parent)
	{
	...
	{
		this.drawString(this.fontRenderer, this.displayText, this.xPosition + 20, this.yPosition + 2, this.isParentChecked() ? 0xFFFFFF : 0x666666);
	...
	{
		return this.isParentChecked() && mouseX > this.xPosition && mouseX < this.xPosition + this.width && mouseY > this.yPosition && mouseY < this.yPosition + 11;
	}
}
