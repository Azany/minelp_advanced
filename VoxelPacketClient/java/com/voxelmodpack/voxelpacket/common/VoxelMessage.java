...
public class VoxelMessage
{
	 ...
	 */
	public VoxelMessage(IVoxelPacketHandler agent, VoxelPacket packet) throws MissingEncoderException
	{
		this.agent          = agent;
		this.sender         = null;
		this.isLocal        = false; 
	 ...
	 * @throws MessageOverflowException Thrown if the inbound packet has a higher index than the maximum packet specified.
	 */
	public VoxelMessage(IVoxelPacketHandler agent, VoxelPacket packet, EntityPlayer sender) throws MissingEncoderException
	{
		this.agent          = agent;
		this.sender         = sender;
		this.isLocal        = false; 
	...
	{
		return this.sender != null ? this.sender.getName() : "Local";
	}
